...
import (
	...
	submarinerdiagnoseconfig "github.com/stolostron/submariner-addon/pkg/client/submarinerdiagnoseconfig/informers/externalversions/submarinerdiagnoseconfig"
...
type SharedInformerFactory interface {
	...
	Submarineraddon() submarinerdiagnoseconfig.Interface
}

func (f *sharedInformerFactory) Submarineraddon() submarinerdiagnoseconfig.Interface {
	return submarinerdiagnoseconfig.New(f, f.namespace, f.tweakListOptions)
}
