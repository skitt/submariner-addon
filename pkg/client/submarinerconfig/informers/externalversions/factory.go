...
type SharedInformerFactory interface {
	...
	Submarineraddon() submarinerconfig.Interface
}

func (f *sharedInformerFactory) Submarineraddon() submarinerconfig.Interface {
	return submarinerconfig.New(f, f.namespace, f.tweakListOptions)
}
